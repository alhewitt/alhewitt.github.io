...
![no-alignment]({{ site.url }}{{ site.baseurl }}/assets/img/igem/T--Exeter--BioR200.png){:width="360px"}{: .align-center}
...
![no-alignment]({{ site.url }}{{ site.baseurl }}/assets/img/igem/T--Exeter--BioR300.png){:width="360px"}{: .align-center}
...
![no-alignment]({{ site.url }}{{ site.baseurl }}/assets/img/igem/T--Exeter--BioR310.png){:width="360px"}{: .align-center}
...
![no-alignment]({{ site.url }}{{ site.baseurl }}/assets/img/igem/labcoat.jpg){:width="360px"}{: .align-center}
